namespace AccountingApp.Forms
{
    ...
    private void InitializeComponent()
    {
      ...
      // txt_AccountId
      // 
      txt_AccountId.Location = new Point(12, 34);
      txt_AccountId.Name = "txt_AccountId";
      txt_AccountId.Size = new Size(176, 27);
      txt_AccountId.TabIndex = 1;
      // 
      // txt_Amount
      // 
      txt_Amount.Location = new Point(12, 122);
      ...
      label2.Location = new Point(350, 115);
      label2.Name = "label2";
      ...
      button1.Location = new Point(240, 287);
